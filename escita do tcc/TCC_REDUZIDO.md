...
O **Smart Plantio** foi desenvolvido por Renan Magalhães Lage como TCC na Universidade Federal de Alfenas (UNIFAL) em 2025, sob orientação do Prof. Dr. Paulo Alexandre Bressan. É plataforma web de gestão agrícola projetada para pequenos produtores, centralizando informações financeiras, de safras e custos (LAGE, 2025). O sistema oferece cadastro de propriedades e talhões, registro de safras, lançamento de custos por categorias, controle de estoque e geração automática de relatórios e gráficos financeiros.

A arquitetura técnica utiliza tecnologias consolidadas: backend em Node.js/Express (serviços REST escaláveis), frontend em React/Vite (interfaces reativas componentizadas), e persistência em MySQL/Sequelize (banco relacional com ORM) (LAGE, 2025).

Este trabalho, também vinculado à UNIFAL e orientado pelo Prof. Dr. Paulo Alexandre Bressan, parte da plataforma já existente mas com foco diferenciado e complementar. Enquanto o TCC de Lage abordou desenvolvimento técnico, este trabalho dedica-se à avaliação científica da **usabilidade**, reconhecendo que facilidade de uso é tão importante quanto solidez técnica, especialmente para público com diferentes níveis de letramento digital (CYBIS; BETIOL; FAUST, 2015; NIELSEN, 1993).
