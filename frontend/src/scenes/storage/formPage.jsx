...
import { Box, Button, TextField, Typography, useTheme, Autocomplete, useMediaQuery, CircularProgress, IconButton } from "@mui/material";
...
const StorageForm = () => {
  ...
  const fields = [
    ...
    { name: "date", label: "Data de Validade / Vencimento", type: "date" },
